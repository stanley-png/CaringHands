...
const Gallery = () => {
  return (
    <main id="gallery">
      <div className="max-w-6xl px-4 pb-10 sm:px-6 lg:px-8  mx-auto">
        <h1 className="text-center mb-10 text-3xl font-bold text-green-600 sm:text-4xl ">
          Our Gallery
        </h1>
